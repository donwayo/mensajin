   ...
   getPersonalData.done(function(personalData){
	...
	if($("#agenda").length>0){
     ...
     function enviarPopUp(comp){
        ...
        switch(comp){
                case 1:
                    var winpops=window.open("http://www2.movistar.com.gt/webchatsclgt/","","width=328,height=482,resizable");
                    if(!winpops)
                        alert('Tu bloqueador de popups ha bloqueado la ventana, desactivalo para mensajin.com porfavor!');

                    break;
                case 2:
                    var winpops=window.open("http://www2.tigo.com.gt/msn/index.html","","width=328,height=482,resizable");
                    if(!winpops)
                        alert('Tu bloqueador de popups ha bloqueado la ventana, desactivalo para mensajin.com porfavor!');
                    break;
                case 3:
                    var winpops=window.open("http://sms2sv.claro.com.sv/pages/telecomv2.aspx","","width=223,height=295,resizable");
                    if(!winpops)
                        alert('Tu bloqueador de popups ha bloqueado la ventana, desactivalo para mensajin.com porfavor!');
                    break;
                case 5:
